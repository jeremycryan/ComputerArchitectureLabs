...
HD_PWD='/home/comparch/Documents/ComputerArchitectureLabs/Lab2/lab2/lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log midpoint.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source midpoint.tcl -notrace
