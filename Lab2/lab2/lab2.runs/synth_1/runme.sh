...
HD_PWD='/home/comparch/Documents/ComputerArchitectureLabs/Lab2/lab2/lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log midpoint.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source midpoint.tcl
