...
HD_PWD='/home/comparch/Documents/ComputerArchitectureLabs/Lab2/final/final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spiMemory.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spiMemory.tcl -notrace
