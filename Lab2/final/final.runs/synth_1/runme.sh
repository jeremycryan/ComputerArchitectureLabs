...
HD_PWD='/home/comparch/Documents/ComputerArchitectureLabs/Lab2/final/final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spiMemory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spiMemory.tcl
